...
Revision ID: f84831e5990e
Revises: 
Create Date: 2020-06-01 07:42:02.166090
...
def upgrade():
    ...
    sa.Column('cert', sa.String(length=150), nullable=False),
    ...
    sa.Column('description', sa.String(length=1300), nullable=False),
    ...
    sa.Column('question', sa.String(length=750), nullable=True),
    sa.Column('session_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['session_id'], ['Session.s_id'], ondelete='CASCADE'),
